...
if __name__ == "__main__":
    ...
    fits_base = 'test4'
    #fits_base = 'Parkes_70cm_PSR'

    #top_dir = '/data0/FRB_Parkes_data/FRB010125/fil_files'
    top_dir = '/home/vishal/SP_pipeline'

    fits_file = "%s/%s.fits" %(top_dir,fits_base)
